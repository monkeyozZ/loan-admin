  ...
  <div class="bank-form-box">
    ...
    <el-form :rules="rules" ref="dataForm" :model="Form" label-position="left" label-width="120px">
      <el-form-item label="银行名称：" prop="title">
          <el-input v-model="Form.title" placeholder="请输入银行名称" style="width:60%"></el-input>
      </el-form-item>
      <el-form-item label="银行图片：" prop="pic">
          <el-upload
            ref="upload"
            :action="baseapi + 'bank/insert'"
            :file-list="fileList"
            :limit="1"
            :data="Form"
            :auto-upload="false"
