...
class AuthLogin extends Base {
  ...
  async gettoken (req, res, next) {
    ...
    await request.get(
      {
        url: 'https://api.weixin.qq.com/sns/oauth2/access_token?appid=wx83b956b6493bef90&secret=f3d1c96c2f8631a5baf0369cea29a2d9&code=' + req.body.code + '&grant_type=authorization_code'
      },
      (error, response, body) => {
